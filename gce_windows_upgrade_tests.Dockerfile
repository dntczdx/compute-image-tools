...
# Build test runner
WORKDIR /cli_tools_e2e_test/gce_windows_upgrade
COPY cli_tools_e2e_test/gce_windows_upgrade/ .
RUN CGO_ENABLED=0 go build -o /gce_windows_upgrade_test_runner
...
COPY /cli_tools/gce_windows_upgrade/upgrade_script_2008r2_to_2012r2.ps1 /cli_tools/gce_windows_upgrade/upgrade_script_2008r2_to_2012r2.ps1
